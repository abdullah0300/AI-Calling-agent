...
const agentSchema = z.object({
  ...
  interest_detected_message: z.string().min(1),
  not_interested_message: z.string().min(1),
  wrong_person_message: z.string().min(1),
  callback_message: z.string().min(1),
  ...
  active_tts: z.enum(['elevenlabs', 'deepgram', 'google']).default('elevenlabs'),
