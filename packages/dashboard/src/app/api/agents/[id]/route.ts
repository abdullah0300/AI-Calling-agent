...
const agentUpdateSchema = z.object({
  ...
  interest_detected_message: z.string().min(1).optional(),
  not_interested_message: z.string().min(1).optional(),
  wrong_person_message: z.string().min(1).optional(),
  callback_message: z.string().min(1).optional(),
  ...
  active_tts: z.enum(['elevenlabs', 'deepgram', 'google']).optional(),
